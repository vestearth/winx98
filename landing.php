    ...
    <div class="container-fluid">
      ...
      <div class="mx-auto mt-100px" style="max-width: 700px;">
        ...
        <div class="example-game-swiper">
          ...
          <div class="d-flex justify-content-center align-items-center mt-20px mb-10px">
            <button class="thai-button" onclick="window.location.href='login.php<?=
                                                                                // สร้าง URL สำหรับ login โดยใช้ค่า ref ที่เก็บใน cookie
          ...
          <div class="col-12">
            ...
            <div class="faq-section">
              ...
              <div class="faq-item">
                ...
                <div class="faq-answer">
                  <p>กดเข้าเมนูฝาก-ถอน ดูเลขบัญชีที่หน้าฝากก่อนทำรายการทุกครั้ง และอัพสลิปให้ตามเวลาที่กำหนด</p>
                </div>
              </div>
