...
<div class="container-detail py-15px px-0 mb-10px">
  <div class="d-flex align-items-center justify-content-between flex-wrap px-15px">
    <div class="mb-10px">
      <div class="text-uppercase font-16px font-SemiBold">Multiple Address</div>
...
<div class="modal-header">
  <h5 class="modal-title"><?= Itlanguage::translate('Add Address'); ?></h5>
...
<form method="post">
  <div class="modal-body">
    <div class="row">
      <div class="col-lg-12">
        <label class="mb-0"><?= Itlanguage::translate('Consignee'); ?></label>
        <?php TiwForm::normal('text', '', ['name' => 'full_name', 'placeholder' => Itlanguage::translate('Enter'), 'required' => 'required']); ?>
        <label class="mb-0"><?= Itlanguage::translate('Address'); ?></label>
        <?php TiwForm::normal('textarea', '', ['name' => 'address', 'placeholder' => Itlanguage::translate('Enter'), 'required' => 'required']); ?>
        <div class="row">
          <div class="col-6">
            <label class="mb-0"><?= Itlanguage::translate('Sub District'); ?></label>
            <?php TiwForm::normal('text', '', ['name' => 'sub_district', 'placeholder' => 'Enter', 'class' => 'sub_district mb-0', 'required' => '']); ?>
          </div>
          <div class="col-6 mb-10px">
            <label class="mb-0"><?= Itlanguage::translate('District'); ?></label>
            <?php TiwForm::normal('text', '', ['name' => 'district', 'placeholder' => 'Enter', 'class' => 'district mb-0', 'required' => '']); ?>
          </div>
          <div class="col-6 mb-10px">
            <label class="mb-0"><?= Itlanguage::translate('Province'); ?></label>
            <?php TiwForm::normal('text', '', ['name' => 'province', 'placeholder' => 'Enter', 'class' => 'province mb-0', 'required' => '']); ?>
          </div>
          <div class="col-6 mb-10px">
            <label class="mb-0"><?= Itlanguage::translate('Zip Code'); ?></label>
            <?php TiwForm::normal('text', '', ['name' => 'zipcode', 'placeholder' => 'Enter', 'class' => 'zipcode mb-0', 'required' => '']); ?>
          </div>
          <div class="col-12 mb-10px">
            <label class="mb-0"><?= Itlanguage::translate('Phone Number'); ?></label>
...
<div class="modal-header">
  <h5 class="modal-title"><?= Itlanguage::translate('Edit Address'); ?></h5>
  <button type="button" class="close" data-dismiss="modal" aria-label="Close"></button>
</div>
<form method="post">
  <div class="modal-body">
    <div class="row">
      <div class="col-lg-12">
        ...
        <div class="row">
          <div class="col-6">
            <label class="mb-0 mb-10px"><?= Itlanguage::translate('Sub District'); ?></label>
            <?php TiwForm::normal('text', '', ['name' => '{sub_district}', 'placeholder' => 'Enter', 'class' => 'sub_district mb-0', 'required' => '']); ?>
          </div>
          <div class="col-6">
            <label class="mb-0 mb-10px"><?= Itlanguage::translate('District'); ?></label>
            <?php TiwForm::normal('text', '', ['name' => '{district}', 'placeholder' => 'Enter', 'class' => 'district mb-0', 'required' => '']); ?>
          </div>
          <div class="col-6">
            <label class="mb-0 mb-10px"><?= Itlanguage::translate('Province'); ?></label>
            <?php TiwForm::normal('text', '', ['name' => '{province}', 'placeholder' => 'Enter', 'class' => 'province mb-0', 'required' => '']); ?>
          </div>
          <div class="col-6">
            <label class="mb-0 mb-10px"><?= Itlanguage::translate('Zip Code'); ?></label>
            <?php TiwForm::normal('text', '', ['name' => '{zipcode}', 'placeholder' => 'Enter', 'class' => 'zipcode mb-0', 'required' => '']); ?>
          </div>
          <div class="col-12">
            <label class="mb-0"><?= Itlanguage::translate('Phone Number'); ?></label>
