...
$_PAGE['permission'] = ['no_more_game_agent', 'wallet', 'bonus_invite_new'];
...
$summary_data = nga_statistic::getSummaryUserCommissionNew($code);
...
<body class="<?= Structure::getThemeClass(); ?>">
  ...
  <div id="bonus_invite_new" class="container-pagination bg-white  no-border-radius" <?= Homepagify::createHomepagify('bonus_invite_new', '?c=' . $code, '', 'รายการ') ?>>
