...
$_PAGE['permission'] = ['no_more_game_agent', 'management', 'lotto_report'];
...
$select_summary_lotto =  nga_statement::selectBetLottoByDate($code, $from_date, $to_date);
...
<body class="<?= Structure::getThemeClass(); ?>">
  ...
  <?php
  include 'view/lotto/history.php';
  ?>
