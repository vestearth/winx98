  ...
  <div class='bg-whites pb-10px mb-10px'>
    <div class="d-flex top-tap justify-content-between  pt-10px">
      ...
      <div class="msg col-lg-6">
        <div class='topic'>
          รายการโบนัสชวนเพื่อนรายวัน </div>
        <div class="font-14px text-sub ">
          ข้อมูลรายละเอียดรายการโบนัสชวนเพื่อนรายวัน
        </div>
      </div>
    </div>
  </div>

  <div id="bonus_invite_daily" class="container-pagination bg-white  no-border-radius" <?= Homepagify::createHomepagify('bonus_invite_daily', '?c=' . $code, '', 'รายการ') ?>>
    <div class="table-responsive">
      <table class="table table-sort table-search ">
        <thead>
          <tr>
            <th nowrap data-sort="transaction_date" data-filter="<?= Homepagify::dataFilter('transaction_date', 'date') ?>">วันที่ได้ยอด</th>
