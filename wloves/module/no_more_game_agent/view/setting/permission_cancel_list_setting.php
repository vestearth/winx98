...
<div class="d-flex align-items-center justify-content-between my-5px mx-15px">
  <div class="mb-5px">
    <div class="font-18px text-info font-SemiBold">ตั้งค่าสิทธิ์ยกเลิกรายการฝาก
    </div>
    <div class="font-15px text-secondary">จัดการสิทธิ์ยกเลิกรายการฝาก</div>
  </div>
</div>

<div class="editable-card core-new border-radius-0 mb-50px">

  <div id="cancel_permission_setting" class="container-pagination no-border-radius table-square" <?= Homepagify::createHomepagify('cancel_permission_setting', '?c=' . $_GET['c'], '', 'รายชื่อ Admin',) ?>>
