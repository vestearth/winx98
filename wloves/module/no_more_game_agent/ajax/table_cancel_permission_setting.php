        ...
        <div class="d-flex align-items-center">
          ...
          $api = [
            ...
            'params' => [
              'id' => $data['id'],
              'data' => [
                'is_permission_cancel_deposit' => '{is_permission_cancel_deposit}',
              ]
            ]
          ];
          $optional = [
          ...
          TiwForm::liveForm('checkbox', 'is_permission_cancel_deposit', $data['is_permission_cancel_deposit'], $api, $optional);
          ?>
        </div>
      </td>
    </tr>
