...
<body>
  ...
  if ($is_login) {
    ...
    $data = [
      ...
      'detail' => 'เข้าหน้าประวัติกิจกรรมสล็อตเสี่ยงโชค',
    ];
  ...
  <div class="container position-relative">
      ...
      <div class="col-12">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb breadcrumb-custom mb-10px">
            ...
            <li class="breadcrumb-item active" aria-current="page"><?= Ty::get('fortunesslot') ?></li>
          </ol>
        </nav>
      </div>
    </div>
    <div class="row">
      <div class="col-12">
        ...
        <div id="game_slot_history" class="container-pagination table-custom" data-page_size="15" <?= Homepagify::createHomepagify('game_slot_history', '', '', Ty::get('slot_reward'), ''); ?>>
